...
const detectorLabel = document.getElementById('detectorLabel');
...
function preload() {
  ...
  detectorLabel.innerText='Detector object is loaded. Hold on...';
}
...
function setup() {
  ...
  video.elt.addEventListener('loadeddata', function() {
    ...
    if (video.elt.readyState >= 2) {
      ...
      detectorLabel.innerText='Video element is ready! Click "Start Detecting" to see the magic!';
    }
  });
}
